...
import { playgroundItems } from '@/app/(public)/hobby/playground/_components/playgroundData';
...
import {
  ...
  WorkspaceCodeCard,
  WorkspaceEmptyState,
} from '@/app/(public)/hobby/_components/workspace';
...
function PlaygroundPageContent() {
  const { activeTab, defaultTab, onChangeTab } = useSyncedTab(tabs, '/hobby/playground');
