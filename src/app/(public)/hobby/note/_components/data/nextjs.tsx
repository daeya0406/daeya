...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html data-theme={initialTheme} className={initialTheme === 'dark' ? 'dark' : undefined}>
      ...
      {
        label: 'shared/providers/ThemeProvider.tsx',
        code: `// shared/providers/ThemeProvider.tsx
'use client';
...
export function useTheme() {
  ...
  return ctx;
      ...
      {
        label: 'shared/widgets/ThemeToggleButton.tsx',
        code: `// shared/widgets/ThemeToggleButton.tsx
'use client';
