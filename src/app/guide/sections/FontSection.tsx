        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {headingTokens.map((t) => (
            <button
              ...
              className="border-border group flex flex-col items-start rounded-lg border bg-depth-1 p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
            >
