      ...
      <Tabs.Root value={activeTab} defaultValue={defaultTab} onValueChange={onChangeTab}>
        ...
        <Tabs.Content key={activeTab} value={activeTab}>
          <div className="grid gap-6 pt-6 lg:grid-cols-[260px_minmax(0,1fr)] lg:items-start">
            ...
            <div className="space-y-4 rounded-xl border border-border bg-bg-depth-1 p-5 shadow-sm">
              {activeItem ? (
                <>
                  ...
                  {activeItem.demo && (
                    <div className="rounded-lg border border-border bg-bg-depth-2 p-4">{activeItem.demo}</div>
                  )}

                  <div className="rounded-lg border border-border bg-bg-depth-3 p-4 text-sm">
