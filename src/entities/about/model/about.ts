...
/** FE 메인 옆가지 — 협업 소통용. 홈/내비 1뎁스에 올리지 않음 */
export const ABOUT_ADJACENT = [
  {
    ...
    links: [
      {
        label: '가이드 보기',
        href: 'https://setting-guide-scss.vercel.app/',
      },
      {
        label: 'GitHub',
        href: 'https://github.com/daeya-playground/scss',
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        label: 'GitHub',
        href: 'https://github.com/daeya0406/2026-toss-pd-challenge',
      },
    ],
  },
  {
    ...
    links: [
      {
        label: 'Spring',
        href: 'https://github.com/daeya-playground/spring',
      },
      {
        label: 'Vue',
        href: 'https://github.com/daeya-playground/vue',
      },
    ],
  },
];
