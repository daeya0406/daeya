...
export function DashboardSidebar() {
  ...
  const iconButtonClassName =
    'flex h-9 w-9 items-center justify-center rounded-xl text-icon-primary transition hover:bg-bg-tertiary hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30';

  return (
    <aside
      className={[
        'border-border bg-bg-primary/75 sticky top-0 hidden h-dvh flex-col border-r backdrop-blur lg:flex',
    ...
    >
          ...
          {groups.map((group) => {
                ...
                <button
                  ...
                  className={[
                    ...
                    groupActive
                      ...
                      : 'text-text-default hover:bg-bg-tertiary',
                  ].join(' ')}
                >
            ...
            return (
              <AccordionItem key={group.label} value={group.label} className="border-none">
                <AccordionTrigger
                  className={[
                    'hover:bg-bg-tertiary rounded-xl px-3 py-2 text-sm hover:no-underline',
      ...
      <div className="border-border border-t px-5 py-4">
        <div className="flex items-center gap-3">
          <div className="bg-bg-tertiary text-icon-primary flex h-10 w-10 items-center justify-center rounded-full">
