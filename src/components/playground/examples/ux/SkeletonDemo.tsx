        ...
        <div className="rounded-lg border border-border bg-bg-depth-1 p-3 text-sm">
          ...
          {loading ? (
            <div className="mt-2 space-y-2">
              <div className="h-4 w-3/4 animate-pulse rounded bg-bg-depth-3" />
              <div className="h-4 w-5/6 animate-pulse rounded bg-bg-depth-3" />
              <div className="h-4 w-2/3 animate-pulse rounded bg-bg-depth-3" />
            </div>
          ) : (
